...
export const GOOGLE_APPS_SCRIPT_INTRANET_URL = "https://script.google.com/macros/s/AKfycbx5KaM66s5IAF3tibw4djAz1_lhwUtR66izTjaKCloR2nSGrShcb0L_Bgw_kHZbHhwrkw/exec";
...
export async function postToIntranetAPI(action, payload) {
  ...
  const response = await fetch(GOOGLE_APPS_SCRIPT_INTRANET_URL, {
    method: "POST",
    headers: {
      "Content-Type": "application/json" // Apps Script procesará esto via e.postData.contents
    },
