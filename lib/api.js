...
export const GOOGLE_SHEETS_METRICAS_CSV = "PENDIENTE_DE_URL_METRICAS";

// La URL de Google Sheets CSV para Intranet (Formatos)
export const GOOGLE_SHEETS_INTRANET_CSV = "PENDIENTE_DE_URL_INTRANET";
