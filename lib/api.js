...
// La URL de Google Sheets CSV para la pestaña unificada Oportunidades (Convocatorias y Empleos)
export const GOOGLE_SHEETS_CONVOCATORIAS_CSV = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSvhGd3raf0l8PJyLnqU49p8Qli10E8eR8Jbc-6vwyk9_Jgjj7WJDdAEmejgSVtPqTroDIXgJ8kMpxu/pub?gid=2001&single=true&output=csv";

// La URL de Google Sheets CSV para Ofertas de Empleo / Vacantes (en desuso, unificado)
export const GOOGLE_SHEETS_OFERTAS_CSV = "PENDIENTE_DE_URL_OFERTAS";
...
export async function getDynamicPrograms() {
  try {
    const data = await fetchGoogleSheetData("https://docs.google.com/spreadsheets/d/e/2PACX-1vSvhGd3raf0l8PJyLnqU49p8Qli10E8eR8Jbc-6vwyk9_Jgjj7WJDdAEmejgSVtPqTroDIXgJ8kMpxu/pub?gid=164572338&single=true&output=csv");
    ...
    return data.map(row => {
      ...
      return {
        id: row.slug?.trim() || `prog-${Math.random()}`,
