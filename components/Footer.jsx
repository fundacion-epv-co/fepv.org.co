...
export default function Footer() {
  ...
  const foundationName = config?.nombre_fundacion || "Fundaci贸n Encuentros Para la Vida";
  ...
  return (
    <footer className="bg-fepv-darkblue text-white/90 border-t border-fepv-darkblue/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="font-display font-bold text-lg text-white leading-none">
                  {config?.nombre_fundacion || "Fundaci贸n Encuentros"}
                </span>
        ...
        {/* Secci贸n de Copyright y Enlaces Legales */}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 pt-4 border-t border-white/10 mt-6 text-xs text-white/50 text-justify"><p><strong>Aviso de Privacidad y Tratamiento de Datos Personales (Ley 1581 de 2012):</strong> La Fundaci髇 Encuentros Para la Vida (NIT 902074412-0) informa que los datos personales obtenidos a trav閟 de este sitio web ser醤 procesados exclusivamente con fines institucionales y de gesti髇 de usuarios. El titular tiene derecho a conocer, actualizar y rectificar su informaci髇 contact醤donos a fundacion.epv.co@gmail.com.</p></div></footer>
  );
}
