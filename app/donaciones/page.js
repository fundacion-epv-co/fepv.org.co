...
export default function Donaciones() {
  ...
  const budgetAllocation = [
    ...
    { area: "Actividades Comunitarias y Conservación", pct: 10, color: "bg-fepv-yellow" },
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white p-6 sm:p-10 rounded-3xl border border-gray-150 shadow-md space-y-6">
            <h2 className="font-display font-bold text-xl text-fepv-dark">
              Simulador de Aporte
            </h2>
            ...
            {simulatedSubmit ? (
              <div className="p-8 bg-fepv-light/60 border border-fepv-green/20 rounded-2xl text-center space-y-4 animate-in fade-in duration-300">
                ...
                <h3 className="font-display font-bold text-base text-fepv-dark">¡Gracias por tu intención de apoyo!</h3>
                ...
                <div className="p-4 bg-white rounded-xl text-left border border-fepv-green/10 text-xs space-y-2 max-w-md mx-auto">
                  <p className="font-bold text-fepv-dark text-center mb-1">Para completar tu transferencia bancaria directa:</p>
              ...
              <form onSubmit={handleDonateSubmit} className="space-y-6 text-xs sm:text-sm">
                ...
                <div className="flex bg-gray-50 p-1.5 rounded-2xl border border-gray-150">
                  <button
                    ...
                    className={`flex-1 py-3 text-center rounded-xl font-bold cursor-pointer transition-colors ${
                      frequency === "unica" ? "bg-white text-fepv-green shadow-sm" : "text-fepv-gray/60 hover:text-fepv-dark"
                    }`}
                  >
                    Donación Única
                  </button>
                  <button
                    ...
                    className={`flex-1 py-3 text-center rounded-xl font-bold cursor-pointer transition-colors ${
                      frequency === "recurrente" ? "bg-white text-fepv-green shadow-sm" : "text-fepv-gray/60 hover:text-fepv-dark"
                    }`}
                  >
                ...
                <div className="space-y-2">
                  <label className="block text-xs font-bold text-fepv-dark">Selecciona un monto (COP):</label>
                ...
                {/* Custom Value */}
                <div className="space-y-2">
                  <label className="block text-xs font-bold text-fepv-dark">O ingresa otro valor (COP):</label>
                ...
                {finalAmount > 0 && (
                  <div className="p-4 bg-fepv-light/40 rounded-2xl border border-fepv-green/10 text-center">
                    ...
                    <p className="text-xl sm:text-2xl font-display font-bold text-fepv-dark mt-1">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-gray-150 shadow-sm space-y-6">
            <h3 className="font-display font-bold text-lg text-fepv-dark">
            ...
            <div className="space-y-4">
              {budgetAllocation.map((alloc, idx) => (
                <div key={idx} className="space-y-1.5">
                  <div className="flex items-center justify-between text-xs font-semibold text-fepv-dark">
          ...
          <div className="bg-fepv-light/20 p-6 rounded-3xl border border-fepv-green/10 space-y-3">
            <h4 className="font-display font-bold text-sm text-fepv-dark">🛡️ Deducción de Impuestos</h4>
            <p className="text-xs text-fepv-gray/80 leading-relaxed">
