      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <div className="prose prose-lg prose-fepv max-w-none text-fepv-gray">
            ...
            <h2 className="font-display font-bold text-2xl text-fepv-dark mt-8 mb-4">1. Uso del Sitio Web</h2>
            <p>
            ...
            <h2 className="font-display font-bold text-2xl text-fepv-dark mt-8 mb-4">2. Propiedad Intelectual</h2>
            <p>
            ...
            <h2 className="font-display font-bold text-2xl text-fepv-dark mt-8 mb-4">3. Enlaces a Otros Sitios Web</h2>
            <p>
            ...
            <h2 className="font-display font-bold text-2xl text-fepv-dark mt-8 mb-4">4. Limitación de Responsabilidad</h2>
            <p>
