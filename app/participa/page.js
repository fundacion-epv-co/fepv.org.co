    ...
    <div className="space-y-8 animate-in fade-in duration-300">
        ...
        <button
          ...
          className={`flex-1 text-center py-4 font-display font-bold text-xs sm:text-sm border-b-2 cursor-pointer transition-colors ${
            activeTab === "beneficiario"
              ...
              : "border-transparent text-fepv-gray/60 hover:text-fepv-dark"
          }`}
        >
          🙋 Soy Beneficiario
        </button>
      ...
      {successMessage ? (
        <div className="p-8 bg-fepv-light/50 border border-fepv-green/20 rounded-3xl text-center space-y-4 max-w-xl mx-auto">
          ...
          <h3 className="font-display font-bold text-lg text-fepv-dark">¡Formulario enviado por WhatsApp!</h3>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-10 rounded-3xl border border-gray-150 shadow-sm max-w-2xl mx-auto space-y-6 text-xs sm:text-sm">
          ...
          {activeTab === "beneficiario" && (
            <div className="space-y-4">
              <h3 className="font-display font-bold text-lg text-fepv-dark mb-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Documento de Identidad *</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Celular de contacto (WhatsApp) *</label>
                  <input type="tel" required name="telefono" value={formData.telefono} onChange={handleInputChange}
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-fepv-green"
                    placeholder="300 000 0000" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Programa de interés *</label>
          ...
          {activeTab === "voluntario" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">WhatsApp de contacto *</label>
                  <input type="tel" required name="telefono" value={formData.telefono} onChange={handleInputChange}
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-fepv-green"
                    placeholder="300 000 0000" />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Área de interés *</label>
              ...
              <div>
                <label className="block text-xs font-bold text-fepv-dark mb-1">Perfil Académico / Laboral *</label>
          ...
          {activeTab === "aliado" && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Organización / Entidad *</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Nombre Representante / Delegado *</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Correo Corporativo *</label>
                  <input type="email" required name="correo" value={formData.correo} onChange={handleInputChange}
                    className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:border-fepv-green"
                    placeholder="contacto@empresa.com" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-fepv-dark mb-1">Propuesta de Cooperación *</label>
              ...
              <div>
                <label className="block text-xs font-bold text-fepv-dark mb-1">Descripción de la propuesta *</label>
