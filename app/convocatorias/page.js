      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {filteredConvocatorias.length === 0 ? (
          <div className="text-center py-16 bg-gray-50 rounded-3xl border border-gray-100 max-w-md mx-auto space-y-4">
            ...
            <h3 className="font-display font-bold text-lg text-fepv-dark">No hay convocatorias activas</h3>
                  ...
                  <div className="space-y-3 max-w-2xl">
                    <div className="flex items-center gap-3 flex-wrap">
                      <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded ${
                        c.category === "cursos" ? "bg-green-100 text-fepv-dark" :
                    ...
                    <h3 className="font-display font-bold text-lg text-fepv-dark leading-snug">
                      {c.title}
                    </h3>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl p-6 sm:p-8 space-y-6 relative border border-gray-150">
            ...
            <button
              ...
              className="absolute top-4 right-4 text-fepv-gray/60 hover:text-fepv-dark cursor-pointer p-1.5 rounded-full hover:bg-gray-100 transition-colors"
            ...
            <div className="space-y-2 pr-8">
              ...
              <h2 className="font-display font-bold text-xl sm:text-2xl text-fepv-dark leading-snug">
            ...
            <div className="space-y-4 border-t border-b border-gray-100 py-4 text-xs sm:text-sm text-fepv-gray/90">
              <div>
                <h4 className="font-bold text-fepv-dark mb-1">Descripción de la oportunidad:</h4>
                <p className="leading-relaxed text-xs">{selectedConvocatoria.desc}</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <div>
                  <h4 className="font-bold text-fepv-dark mb-1.5">Requisitos obligatorios:</h4>
                  <ul className="list-disc pl-4 space-y-1">
                    {selectedConvocatoria.requirements.map((r, i) => <li key={i}>{r}</li>)}
                  </ul>
                </div>
                <div>
                  <h4 className="font-bold text-fepv-dark mb-1.5">Documentos requeridos:</h4>
                  <ul className="list-disc pl-4 space-y-1">
            ...
            {selectedConvocatoria.status === "ABIERTA" && (
              <div className="space-y-4">
                <h3 className="font-display font-bold text-base text-fepv-dark">
                  Formulario de Inscripción
                </h3>
                ...
                {successMessage ? (
                  <div className="p-4 bg-fepv-light/60 border border-fepv-green/20 rounded-2xl text-center space-y-2">
                    ...
                    <h4 className="font-display font-bold text-sm text-fepv-dark">¡Inscripción Enviada por WhatsApp!</h4>
                  ...
                  <form onSubmit={handleApplySubmit} className="space-y-3 text-xs sm:text-sm">
                    ...
                    <div>
                      <label className="block text-xs font-bold text-fepv-dark mb-1">¿Por qué deseas participar? *</label>
